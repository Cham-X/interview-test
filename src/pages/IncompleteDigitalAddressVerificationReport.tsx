...
const IncompleteDigitalAddressVerificationReport = () => {
    return (
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4 w-full'>
                ...
                <div className='flex flex-col bg-white rounded-[6px] p-4 sm:p-8 w-full'>
                    <div className="flex items-center justify-between w-full ">
                        ...
                        <div className="text-[#B54708] text-4 font-medium bg-[#FFEFEE] px-2 py-3 rounded-[8px]">Incomplete</div>
                    </div>
...
export default IncompleteDigitalAddressVerificationReport
